...
class _HomePageState extends State<HomePage> {
  ...
  void _showForm(int? id) async {
    if (id != null) {
      ...
      _Contitle.text = existingJournal['title'];
      _Condescription.text = existingJournal['description'];
    }
  ...
  Future<void> _addItem() async {
    await Database.createItem(
        _Contitle.text, _Condescription.text);
    _refreshJournals();
  }

  Future<void> _updateItem(int id) async {
    await Database.updateItem(
        id, _Contitle.text, _Condescription.text);
    _refreshJournals();
  }
